...
class UsernameForm(ModelForm):
    ...
    def clean_username(self):
        ...
        if queryset > 0:
            raise forms.ValidationError("Username exists.Please change another one")
        return username
...
class Task(models.Model):
    ...
    priority = models.CharField(max_length=30, choices=PRIORITIES, default=PRIORITIES[0][0])
...
class TaskForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'title': forms.TextInput(attrs={'placeholder': "What's on you mind today?"}),
